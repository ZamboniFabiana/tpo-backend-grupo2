...
catalogo = Catalogo(host='famazam.mysql.pythonanywhere-services.com', user='famazam', password='f4b14n41969', database='famazam$miapp')


# Carpeta para guardar las imagenes
#ruta_destino = './static/imagenes/'
ruta_destino = '/home/famazam/mysite/static/imagenes/'

# -------------------controlar permiso de usuario ------------------
@app.route("/usuarios", methods=["GET"])
def consultar_usuario():
    usuarios=catalogo.consultar_usuario()
    if usuarios:
        return jsonify(usuarios)
    else:
        return "No tiene permisos", 404
# -------------------controlar permiso de usuario ------------------
